...
add_action( 'tgmpa_register', 'Software_my_theme_register_required_plugins' );
 ...
 */
function Software_my_theme_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			...
			'slug'               => 'Advance Custom Field Pro', // The plugin slug (typically the folder name).
		...
		array(
			'name'         => 'software-companey-plugin', // The plugin name.
			'slug'         => 'software-companey-plugin', // The plugin slug (typically the folder name).
			'source'       => get_template_directory() . '/inc/plugins/software-companey-plugin.zip', // The plugin source.
			'required'     => true, // If false, the plugin is only 'recommended' instead of required.
			'external_url' => '', // If set, overrides default API URL and points to an external URL.
		),
